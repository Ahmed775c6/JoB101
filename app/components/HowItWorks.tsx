        ...
        <div className="bg-gray-950  mt-4 rounded-sm p-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-sm bg-gray-900">
              <h3 className="font-bold p-2  justify-center text-white text-center rounded-sm  bg-gradient-to-br from-blue-00 to-indigo-900 mb-2 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="p-4 rounded-sm bg-gray-900 ">
              <h3 className="font-bold p-2  text-white justify-center text-center rounded-sm  bg-gradient-to-br from-blue-00 to-indigo-900 mb-2 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
